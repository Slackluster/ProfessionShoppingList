----------------------------------------
-- Profession Shopping List: enUS.lua --
----------------------------------------
...
L.WORLD =                                "World"
L.WEEKLY_TREASURES =                     "Weekly Treasures"
...
L.SETTINGS_COOLDOWNSWINDOW_DESC =        "Open the tracking window on login when a cooldown is ready, in addition to the reminder via chat message."
...
L.SETTINGS_HELPTOOLTIP_TITLE =           "Show Help Tooltips"
L.SETTINGS_HELPTOOLTIP_DESC =            "Display what mouse actions exist when hovering over entries in the tracking window."
L.SETTINGS_PERSONALWINDOWS_TITLE =       "Window Position per Character"
L.SETTINGS_PERSONALWINDOWS_DESC =        "Save the window position per character, instead of account wide."
L.SETTINGS_PERSONALRECIPES_TITLE =       "Track Recipes per Character"
L.SETTINGS_PERSONALRECIPES_DESC =        "Track recipes per character, instead of account wide."
L.SETTINGS_SHOWREMAINING_TITLE =         "Show Remaining Reagents"
L.SETTINGS_SHOWREMAINING_DESC =          "Only show how many reagents you still need in the tracking window, instead of have/need."
L.SETTINGS_REMOVECRAFT_TITLE =           "Untrack on Craft"
L.SETTINGS_REMOVECRAFT_DESC =            "Remove one of a tracked recipe when you successfully craft it."
L.SETTINGS_CLOSEWHENDONE_TITLE =         "Close Window When Done"
L.SETTINGS_CLOSEWHENDONE_DESC =          "Close the tracking window after crafting the last tracked recipe."
