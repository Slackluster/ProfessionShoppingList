...
L.SETTINGS_TOOLTIP_TOOLTIP =			"Afficher la quantité de composant dont vous avez besoin dans l’info-bulle de l’objet."
...
L.SETTINGS_ENHANCEDORDERS_TOOLTIP =		"Améliore l’aperçu des récompenses de commande et des commissions. Ajoute des icônes pour les objets d’artisanats, les recettes non apprises et les recettes suivies.\n\n" .. L.REQUIRES_RELOAD
...
L.SETTINGS_REMOVECRAFT_TITLE =			"Retirer la recette du suivi après une fabrication"
L.SETTINGS_REMOVECRAFT_TOOLTIP =		"Retirer une recette suivie lorsqu’elle est terminée."
