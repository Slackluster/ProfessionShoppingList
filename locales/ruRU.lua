...
-- Track new mogs
L.BUTTON_TRACKNEW =						"Отслеживать новые модели"
L.CURRENT_SETTING =						"Текущая настройка:"
L.MODE_APPEARANCES =					"новые появления"
L.MODE_SOURCES =						"новые появления и источники"
...
L.SETTINGS_COOLDOWNS_TITLE =			"Отслеживание рецептов перезарядки"
...
L.SETTINGS_REAGENTQUALITY_TOOLTIP =		"Установите минимальное качество реагентов, которое должно быть, прежде чем " .. app.NameShort .. " включит их в количество предметов. Результаты CraftSim все равно переопределят это."
L.SETTINGS_INCLUDEHIGHER_TITLE =		"Включить более высокое качество"
L.SETTINGS_INCLUDEHIGHER_TOOLTIP =		"Укажите, какие реагенты более высокого качества следует включать при отслеживании реагентов более низкого качества. (Т.е. следует ли включать собственные реагенты 3 уровня при подсчете реагентов уровня 1.)"
...
L.SETTINGS_SLASH_QUANTITY =				"количество"
...
L.SETTINGS_ORIBOSEXCHANGEFIX_TITLE =	"Исправлена ​​подсказка в Oribos Exchange"
...
L.SETTINGS_QA_TOOLTIP =					"Поскольку в игре нет QA, давайте добавим немного своего. Удалим спам в заголовках при входе и <ПКМ для настроек фрейма> в подсказках.\n\n" .. L.REQUIRES_RELOAD
