...
L.SETTINGS_COOLDOWNSWINDOW_DESC =        "Открывать окно отслеживания при входе в игру, когда время восстановления готово, в дополнение к напоминанию в сообщении чата."
...
L.LOW =                                  LOW -- "Low"
L.HIGH =                                 HIGH -- "High"
L.SETTINGS_INCLUDE =                     "Включать более высокое качество"
...
L.SETTINGS_HELPTOOLTIP_TITLE =           "Показать подсказки справки"
L.SETTINGS_HELPTOOLTIP_DESC =            "Отображение действий мыши при наведении курсора на записи в окне отслеживания."
L.SETTINGS_PERSONALWINDOWS_TITLE =       "Положение окна на персонаже"
L.SETTINGS_PERSONALWINDOWS_DESC =        "Сохранение положения окна для каждого персонажа, а не для всей учетной записи."
L.SETTINGS_PERSONALRECIPES_TITLE =       "Отслеживание рецептов для каждого персонажа"
L.SETTINGS_PERSONALRECIPES_DESC =        "Отслеживайте рецепты для каждого персонажа, а не для всей учетной записи."
L.SETTINGS_SHOWREMAINING_TITLE =         "Показать оставшиеся реагенты"
L.SETTINGS_SHOWREMAINING_DESC =          "В окне отслеживания отображается только количество реагентов, которые вам еще нужны, а не количество есть/нужно."
L.SETTINGS_REMOVECRAFT_TITLE =           "Отключить отслеживание на изготовления"
L.SETTINGS_REMOVECRAFT_DESC =            "Удалите один из отслеживаемых рецептов, если вы успешно его изготовили."
L.SETTINGS_CLOSEWHENDONE_TITLE =         "Закрыть окно, когда закончите"
L.SETTINGS_CLOSEWHENDONE_DESC =          "Закройте окно отслеживания после создания последнего отслеживаемого рецепта."
